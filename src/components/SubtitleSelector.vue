  ...
  <div class="subtitle-selector card">
    ...
    <div class="header">
      ...
      <div class="search-container">
        <input v-model="searchText" type="text" placeholder="搜索歌曲..." class="search-input" />
      </div>
    </div>
    ...
    <div class="control-options">
      <div class="filter-type-selector">
        ...
        <select v-model="selectedFilterType" @change="handleFilterTypeChange" class="filter-select">
      ...
      <div class="subtitle-color-toggle">
        ...
        <button
          ...
          class="toggle-btn"
          :class="{ enabled: store.subtitleColorEnabled, disabled: !store.subtitleColorEnabled }"
        >
      ...
      <div class="color-selector">
        ...
        <div
          class="color-preview"
          :style="{ backgroundColor: store.colorPresets[store.selectedColor] }"
        ></div>
        <select v-model="store.selectedColor" @change="handleColorChange" class="color-select">
          <option v-for="(color, name) in store.colorPresets" :key="name" :value="name">
            {{ name }}
          </option>
        </select>
      </div>
